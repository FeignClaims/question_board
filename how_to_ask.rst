...
- "这是一个在线编译器 (:doc:`/share_code/index`) 的链接, 在其中第 43 行有一个我不明白的编译器错误; 你能告诉我如何解决这个错误吗?"
...
- 你可以把代码复制到 Godbolt 或者 Wandbox 这样的在线编译器中 (:doc:`/share_code/index`), 或者如果它少于 20 行左右, 你可以把它粘贴到聊天窗口中——但在这么做之前, 记得格式化代码.
...
.. seealso::
  ...
  - :doc:`/formatter/index` 中介绍了常见软件的格式化代码方法.
...
.. seealso::
  ...
  - :doc:`/debugger/index` 中以 Visual Studio 2022 为例解释了断点调试的使用.
