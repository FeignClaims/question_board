...
.. hint::
  ...
  你也可以通过断点调试观察这个过程, 自己验证一下结果如何. 断点调试非常有用, 请学习 :doc:`/debugger/index` 并完成习题.
...
:cpp:`cin.read(char* output, streamsize count)`
  读入 :cpp:`count` 个字符到 :cpp:`output` 中, 通常用于 :doc:`/faq/binary_io/index`.
...
.. seealso::
  ...
  输入失败的各种情况见于 :doc:`/faq/fstream/index`.
